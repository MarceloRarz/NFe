...
begin
  ...
  ACBrCTe1.DistribuicaoDFePorNSU (cbUF.ItemIndex,'11509676000121',vChave.QuotedString);
      ...
      begin
        ...
        begin
          ...
          begin
           ...
           if docZip.Items[0].schema in [schprocEventoCTe] then //verifica se o arquivo é o XML da NFe (-nfe.xml)
            begin
             ...
             //   XMLDocument1.Active;
                ...
                XMLDocument1.SaveToFile('.\'+I.ToString+'.xml');

        //        ShowMessage('Arquivo salvo:'+'.\'+I.ToString+'.xml');
