...
begin
  ...
  with ACBrNFe1.EventoNFe.Evento.Add do
   begin
     ...
     infEvento.CNPJ     := CNPJ;
     infEvento.dhEvento := now;
     infEvento.tpEvento := teManifDestCiencia;//teManifDestConfirmacao;
   end;
  ACBrNFe1.EnviarEvento(StrToInt(IDLote));
...
// ACBrNFe1.DownloadNFe.Download.CNPJ := '00253137000310';
//
...
// ACBrNFe1.Download;
  ...
  ACBrNFe1.DistribuicaoDFePorChaveNFe(cbUF.ItemIndex,'11509676000121',vChave);
           ...
           if docZip.Items[0].schema in [schprocNFe,schresNFe] then //verifica se o arquivo é o XML da NFe (-nfe.xml)
            begin
             ...
             //   XMLDocument1.Active;
                ...
                XMLDocument1.SaveToFile('.\'+vChave+'.xml');

                ShowMessage('Arquivo salvo:'+'.\'+vChave+'.xml');
